...
<div class="guide w1210 bc mt15">
    ...
    <div class="guide_content fl">
        ...
        <div class="guide_wrap">
            ...
            <div class="hot none">
                <ul>
                    <?php foreach($infos_isHost as $info):?>
                    <li>
                        <dl>
                            <dt><a href="<?php echo U('Index/category',array('goods_id'=>$info['id']))?>"><img
                                    src="<?php echo $info['goods_thumb']?>" alt=""/></a></dt>
                            <dd>
                                <a href="<?php echo U('Index/category',array('goods_id'=>$info['id']))?>"><?php echo $info['goods_name']?></a>
                            </dd>
