    ...
    <form action="/Admin/Privilege/add" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            ...
            <tr>
                ...
                <td>
                    <select name="p_id">
                        ...
                        <option value="<?php echo $info['id']?>"><?php echo str_repeat('--',$info['level']),$info['priv_name']?></option>
                        <?php endforeach?>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type='text' name='module' maxlength="20" value='' size='27'/> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td class="label">对应控制器名称:</td>
                <td>
                    <input type='text' name='controller' maxlength="20" value='' size='27'/> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td class="label">对应方法名称:</td>
                <td>
                    <input type='text' name='action' maxlength="20" value='' size='27'/> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td></td>
