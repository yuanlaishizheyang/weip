...
<div id="tabbar-div">
    <p><span style="float:right; padding: 3px 5px;"><a href="#"><img id="toggleImg"
                                                                     src="/Public/Admin/images/menu_minus.gif" width="9"
                                                                     height="9" border="0" alt="闭合"/></a></span>
    ...
    <div id="menu-list">
        <ul>
            ...
            <li class="explode" key="02_cat_and_goods" name="menu">
                <?php echo $row['priv_name']?>
                <ul>
                    <?php foreach($row['child'] as $item):?>
                    <li class="menu-item"><a href="<?php echo '/'.$item['module_name'].'/'.$item['controller_name'].'/'.$item['action_name']?>" target="main-frame"><?php echo $item['priv_name']?></a></li>
                    <?php endforeach?>
                </ul>
            </li>
            <?php endforeach?>
