  ...
  <?php foreach($infos as $info):?>
    <tr align="center" class="0" id="0_1" id = 'tr_1'>
      <td align="left" class="first-cell" style = 'padding-left="0"'>
        <?php echo str_repeat('----',$info['level']),$info['priv_name']?>
      </td>
      <td align="left" class="first-cell" style = 'padding-left="0"'>
        <?php echo $info['module_name']?>
      </td>
      <td align="left" class="first-cell" style = 'padding-left="0"'>
        <?php echo $info['controller_name']?>
      </td>
      <td align="left" class="first-cell" style = 'padding-left="0"'>
        <?php echo $info['action_name']?>
      </td>
      <td width="24%" align="center">
        <a href="/Admin/Privilege/update/id/<?php echo ($vol["id"]); ?>">编辑</a> |
        <a href="/Admin/Privilege/delete/id/<?php echo ($vol["id"]); ?>" title="移除">移除</a>
      </td>
    </tr>
  <?php endforeach?>
  </table>
