...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr align="center" class="0" id="0_1" id = 'tr_1'>
      <td align="left" class="first-cell" style = 'padding-left="0"'>
        ...
        <span><a href="#" ><?php echo ($vol["cat_name"]); ?></a></span>
      </td>
      <td width="10%">0</td>
      ...
      <td width="24%" align="center">
        <a href="#">转移商品</a> |
        <a href="/Admin/Category/update/id/<?php echo ($vol["id"]); ?>">编辑</a> |
        <a href="/Admin/Category/delete/id/<?php echo ($vol["id"]); ?>" title="移除">移除</a>
      </td>
