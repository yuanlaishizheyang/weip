...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
        <form action="/Admin/Admin/add" method="post" name="theForm">
            <!-- 最大文件限制 -->
            ...
            <table width="90%" id="general-table" align="center">
                <tr>
                    ...
                    <td><input type="text" name="admin_name" value="" style="float:left;color:;" size="30"/></td>
                </tr>
                <tr>
                    <td class="label">管理员密码：</td>
                    <td><input type="text" name="admin_password" value="" style="float:left;color:;" size="30"/></td>
                </tr>
                <tr>
                    <td class="label">确认密码：</td>
                    <td><input type="text" name="confirm_password" value="" style="float:left;color:;" size="30"/></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select name="role_id" id="">
                            ...
                            <option value="<?php echo $info['id']?>"><?php echo $info['role_name']?></option>
                            <?php endforeach?>
                        </select>
                    </td>
                </tr>
